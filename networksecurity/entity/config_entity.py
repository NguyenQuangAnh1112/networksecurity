...
class TrainingPipelineConfig:
    def __init__(self, timestamp=datetime.now()):
        ...
        self.artifact_name = training_pipeline.PIPELINE_NAME
...
class DataValidationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        self.data_valildation_dir: str = os.path.join(
            training_pipeline_config.artifact_dir,
            training_pipeline.DATA_VALIDATION_DIR_NAME,
        )

        self.valid_data_dir: str = os.path.join(
            self.data_valildation_dir, training_pipeline.DATA_VALIDATION_VALID_DIR
        )

        self.invalid_data_dir: str = os.path.join(
            self.data_valildation_dir, training_pipeline.DATA_VALIDATION_INVALID_DIR
        )
        ...
        self.drift_report_file_path: str = os.path.join(
            self.data_valildation_dir,
            training_pipeline.DATA_VALIDATION_DRIFT_REPORT_DIR,
            training_pipeline.DATA_VALIDATION_DRIFT_REPOR_FILE_NAME,
        )
...
class DataTransformationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.data_transformation_transformed_data_dir: str = os.path.join(
            self.data_transformation_dir,
            training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
        )

        self.data_transformation_transformed_object_dir: str = os.path.join(
            self.data_transformation_dir,
